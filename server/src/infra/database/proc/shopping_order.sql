DROP PROCEDURE IF EXISTS shopping_cart_create_order_v2;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `shopping_cart_create_order_v2`(IN inCartId TEXT,
...
BEGIN
  ...
  CALL shopping_cart_empty_v2(inCartId);
